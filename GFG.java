...
class GFG {
	...
	static boolean leftTruPrime(int n) {
		...
		for (int i = cnt; i > 0; i--) {
			...
			/*
			 * n=113, cnt=3 i=3 mod=1000 n%mod=113 i=2 mod=100 n%mod=13 i=3 mod=10 n%mod=3
			 */
			int mod = power(10, i);
	...
	public static void main(String args[]) {
		...
		if (leftTruPrime(n))
			System.out.println(n + " is left truncatable prime");
		else
			System.out.println(n + " is not left truncatable prime");
	}
}
